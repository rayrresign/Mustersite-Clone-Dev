...
if(!is_admin()) add_filter( 'script_loader_tag', 'set_async_scripts', 10, 3 );

function set_no_async_scripts( $tag, $handle, $src ) {
	// removed defer by res-script
...
if(!is_admin()) add_filter( 'script_loader_tag', 'set_no_async_scripts', 10, 3 );
?>