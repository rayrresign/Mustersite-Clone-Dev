...
<?php 
	$image_res_crop = wp_get_attachment_image_src(get_option('res_logohome')['homescreen_bild_mobile']); // STANDARD CROP FÜR MOBILE???
?>
<section class="rev-slider rev-homescreen"> 
...
<?php 
function revslider_slider_homescreen_mobile(){
?>
...
add_action('wp_footer', 'revslider_slider_homescreen_mobile');
